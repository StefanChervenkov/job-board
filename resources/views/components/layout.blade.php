            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="shrink-0">
                            <img class="size-8" src="images/bg-flag.png" alt="Your Company">
                        </div>
                            ...
                            <div class="relative ml-3">
                                <div>
                                    <button type="button"
                                        ...
                                        <img class="size-8 rounded-full bg-white-300" src="images/userIcon.svg"
                                            alt="">
                                    </button>
                                </div>
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pt-4 pb-3">
                    <div class="flex items-center px-5">
                        <div class="shrink-0">
                            <img class="size-10 rounded-full" src="{{ asset('images/userIcon.svg') }}" alt="">
                        </div>
                        <div class="ml-3">
                            <div class="text-base font-medium text-white">Stefan Chervenkov</div>
                        </div>
                        <button type="button"
